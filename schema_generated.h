...
struct MonsterVecT : public flatbuffers::NativeTable {
  typedef MonsterVec TableType;
  std::vector<std::unique_ptr<MyGame::Sample::MonsterT>> monsters{};
};

struct MonsterVec FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef MonsterVecT NativeTableType;
  typedef MonsterVecBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_MONSTERS = 4
  };
  const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Monster>> *monsters() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Monster>> *>(VT_MONSTERS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
  ...
  MonsterVecT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(MonsterVecT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<MonsterVec> Pack(flatbuffers::FlatBufferBuilder &_fbb, const MonsterVecT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct MonsterVecBuilder {
  typedef MonsterVec Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_monsters(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Monster>>> monsters) {
    fbb_.AddOffset(MonsterVec::VT_MONSTERS, monsters);
  }
...
inline flatbuffers::Offset<MonsterVec> CreateMonsterVec(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Monster>>> monsters = 0) {
...
inline flatbuffers::Offset<MonsterVec> CreateMonsterVecDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<MyGame::Sample::Monster>> *monsters = nullptr) {
  auto monsters__ = monsters ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::Monster>>(*monsters) : 0;
  return MyGame::Sample::CreateMonsterVec(
      _fbb,
      monsters__);
}

flatbuffers::Offset<MonsterVec> CreateMonsterVec(flatbuffers::FlatBufferBuilder &_fbb, const MonsterVecT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline void Monster::UnPackTo(MonsterT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = weapons(); if (_e) { _o->weapons.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->weapons[_i]) { _e->Get(_i)->UnPackTo(_o->weapons[_i].get(), _resolver); } else { _o->weapons[_i] = std::unique_ptr<MyGame::Sample::WeaponT>(_e->Get(_i)->UnPack(_resolver)); }; } } }
...
inline MonsterVecT *MonsterVec::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<MonsterVecT>(new MonsterVecT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void MonsterVec::UnPackTo(MonsterVecT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = monsters(); if (_e) { _o->monsters.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->monsters[_i]) { _e->Get(_i)->UnPackTo(_o->monsters[_i].get(), _resolver); } else { _o->monsters[_i] = std::unique_ptr<MyGame::Sample::MonsterT>(_e->Get(_i)->UnPack(_resolver)); }; } } }
}

inline flatbuffers::Offset<MonsterVec> MonsterVec::Pack(flatbuffers::FlatBufferBuilder &_fbb, const MonsterVecT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateMonsterVec(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<MonsterVec> CreateMonsterVec(flatbuffers::FlatBufferBuilder &_fbb, const MonsterVecT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MonsterVecT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _monsters = _o->monsters.size() ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::Monster>> (_o->monsters.size(), [](size_t i, _VectorArgs *__va) { return CreateMonster(*__va->__fbb, __va->__o->monsters[i].get(), __va->__rehasher); }, &_va ) : 0;
  return MyGame::Sample::CreateMonsterVec(
      _fbb,
      _monsters);
}
...
inline const MyGame::Sample::MonsterVec *GetMonsterVec(const void *buf) {
  return flatbuffers::GetRoot<MyGame::Sample::MonsterVec>(buf);
}

inline const MyGame::Sample::MonsterVec *GetSizePrefixedMonsterVec(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<MyGame::Sample::MonsterVec>(buf);
}

inline bool VerifyMonsterVecBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MyGame::Sample::MonsterVec>(nullptr);
}

inline bool VerifySizePrefixedMonsterVecBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MyGame::Sample::MonsterVec>(nullptr);
}

inline void FinishMonsterVecBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<MyGame::Sample::MonsterVec> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<MyGame::Sample::MonsterVecT> UnPackMonsterVec(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<MyGame::Sample::MonsterVecT>(GetMonsterVec(buf)->UnPack(res));
}

inline std::unique_ptr<MyGame::Sample::MonsterVecT> UnPackSizePrefixedMonsterVec(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<MyGame::Sample::MonsterVecT>(GetSizePrefixedMonsterVec(buf)->UnPack(res));
}
